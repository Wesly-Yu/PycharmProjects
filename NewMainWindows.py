...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.treeWidget1 = QtWidgets.QTreeView(self.splitter)
        self.treeWidget1.setMinimumSize(QtCore.QSize(100, 200))
        self.treeWidget1.setMaximumSize(QtCore.QSize(300, 400))
        # self.treeWidget1.setColumnCount(1)
        self.treeWidget1.setObjectName("treeWidget")
        # self.treeWidget1.setHeader('工程目录')
        self.treeWidget_2 = QtWidgets.QTreeView(self.splitter)
        self.treeWidget_2.setMinimumSize(QtCore.QSize(100, 100))
        self.treeWidget_2.setMaximumSize(QtCore.QSize(300, 400))
        # self.treeWidget_2.setColumnCount(1)
        self.treeWidget_2.setObjectName("treeWidget_2")
        # self.treeWidget_2.headerItem().setText(0, "公共资源")
        self.treeWidget_2.header().setDefaultSectionSize(124)
